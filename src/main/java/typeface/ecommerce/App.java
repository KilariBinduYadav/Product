...
public class App implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Products prod2 = new Products(
                ...
                "Black dark wash 5-pocket mid-rise jeans, clean look, no fade, has a button and zip closure, and waistband with belt loops", "M");
        Products prod3 = new Products(
                103,
                "Women Fade Blue Jeans",
                759.0,
                "Women Straight Fit High-Rise Low Distressed Light Fade Cotton Jeans",
                "Medium shade, light fade blue jeans, Straight fit, high-rise, Low distressed, Non stretchable and 5 pockets", "W");
        Products prod4 = new Products(
                104,
                "Women Cotton Top",
                1049.0,
                "Blue Print Mandarin Collar Empire Pure Cotton Top",
                "Blue longline empire top.Ethnic motifs print.Mandarin collar, three-quarter, cuffed sleeves.Woven cotton.", "W");
        Products prod5 = new Products(
                105,
                "Men Black Shirt",
                649.0,
                "Men Black Slim Fit Casual Shirt",
                "Black solid opaque Casual shirt ,has a spread collar, button placket, na pocket, short regular sleeves, straight hem", "M");
        Products prod6 = new Products(
                106,
                "Women Ethnic Saree",
                1944.0,
                "Ethnic Motifs Zari Pure Georgette Kanjeevaram Saree",
                "The saree comes with an unstitched blouse piece. The blouse worn by the model might be for modelling purpose only.", "W");
        Products prod7 = new Products(
                107,
                "Men Sneakers",
                936.0,
                "Roadster Men Brown Textured PU Sneakers",
                "A pair of round toe brown sneakers ,has regular styling,Lace-ups detail,Pu upper,Cushioned footbed,Textured and patterned outsole.", "M");
